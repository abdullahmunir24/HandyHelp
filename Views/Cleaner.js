    ...
    <View style={styles.container}>
      ...
      {currentUser ? (
        <>
          ...
          <Text style={styles.text}>
            Expected Salary: {currentUser.salary || "Not filled"}
          </Text>
          <Text style={styles.text}>
            Years of Expereince: {currentUser.experience || "Not filled"}
          </Text>
          <Text style={styles.text}>
            Hours to work: {currentUser.work || "Not filled"}
          </Text>
          <Text style={styles.text}>
            Time Pref: {currentUser.time || "Not filled"}
          </Text>
          <Text style={styles.text}>
            Bio: {currentUser.info || "Not filled"}
          </Text>
        </>
      ) : (
